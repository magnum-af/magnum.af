...
TEST(NonEquiDemag, DistanceFromIndexTest) {
    ...
    EXPECT_EQ(newell_nonequi::nonequi_index_distance(vz, 0, 3, false),
              1 + 2 + 3); // Note:
    // This is not out of bound because distance is from i to j-1. The arising
    // warning is surpressed here.
}
