...
int main(int argc, char** argv)
{
    ...
    vti_writer_micro(llg.llgterms[0]->h(state_1), state_1.mesh, filepath + "h_demag");
    vti_writer_micro(llg.llgterms[1]->h(state_1), state_1.mesh, filepath + "h_exchRKKY");
    vti_writer_micro(llg.llgterms[2]->h(state_1), state_1.mesh, filepath + "h_aniso");
    vti_writer_micro(llg.llgterms[3]->h(state_1), state_1.mesh, filepath + "h_dmi");
    vti_writer_micro(llg.llgterms[4]->h(state_1), state_1.mesh, filepath + "h_external");
