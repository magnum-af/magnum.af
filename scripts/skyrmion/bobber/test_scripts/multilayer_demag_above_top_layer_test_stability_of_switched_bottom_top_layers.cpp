...
void set_air_to_zero(af::array &m)
{
    ...
    m(af::span, af::span, af::seq(32, af::end), af::span) = 0;
}
...
int main(int argc, char **argv)
{
    ...
    af::array m_readin;
    Mesh mesh_readin;
    vti_reader(m_readin, mesh_readin, filepath + "m_input.vti");

    af::array m = m_readin;
    m(af::span, af::span, 0, af::span) = m_readin(af::span, af::span, 31, af::span);
    m(af::span, af::span, 31, af::span) = m_readin(af::span, af::span, 0, af::span);
