...
int main(int argc, char** argv) {
    ...
    // af::array values = af::iota(af::dim4(nx * ny * nz * 3, 1), af::dim4(1),
    // f64); af::print("values", values); af::array val2 = af::moddims(values,
    // nx, ny, nz, 3); af::print("val2", val2); af::print("", val2(1,0,1,1));
    ...
    // af::array A_COO = af::sparse((dim_t) cvals.size(), (dim_t) cvals.size(),
    // vals, mindex, nindex, AF_STORAGE_COO); af::print("", A_COO); af::array
    // A_CSR = af::sparseConvertTo(A_COO, AF_STORAGE_CSR); af::print("", A_CSR);
    ...
    // 2nd field crashes with invalid buffer size//const int nx = 128, ny=128 ,
    // nz=4;
