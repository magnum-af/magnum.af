...
fields = [
    ...
    NonequiExchangeField(ne_mesh, Aex, verbose = True),
...
field = Field(maxField = 2./Constants.mu0 , simtime = 1000e-9, startField = 0.9 * H_analytic/Constants.mu0)
