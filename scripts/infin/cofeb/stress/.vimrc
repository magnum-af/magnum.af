...
nnoremap <buffer> <F3> :exec '!if [ -d "todel/py1/" ]; then rm -r todel/py1/; fi; PYTHONPATH=../../../../build/python python2' shellescape(@%, 1)' todel/py1/'<cr>
" run python3  with argument todel/py1
nnoremap <buffer> <F4> :exec '!if [ -d "todel/py1/" ]; then rm -r todel/py1/; fi; PYTHONPATH=../../../../build/python python3' shellescape(@%, 1)' todel/py1/'<cr>
" execute
