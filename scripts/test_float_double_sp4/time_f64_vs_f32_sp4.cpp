...
int main(int argc, char** argv)
{
    ...
    std::cout << "integr steps used:" << state.steps << std::endl;
    std::cout << "type f64 = " << af::constant(0., 1, f64).type() << std::endl;
    std::cout << "type f32 = " << af::constant(0., 1, f32).type() << std::endl;
    std::cout << "m.type() = " << state.m.type() << std::endl;
    //if(state.m.isdouble()) std::cout << "m is double" << std::endl;
    //if(state.m.isfloating()) std::cout << "m is float" << std::endl;
    //if(state.m.isrealfloating()) std::cout << "m is real float" << std::endl;
    return 0;
}
