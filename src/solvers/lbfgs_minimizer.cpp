...
af::array LBFGS_Minimizer::Gradient(const State& state){
    ...
    return 1./(state.material.mu0 * state.material.ms) * cross4(state.m, cross4(state.m, Heff(state)));// TODO elaborate correct way

    //return cross4(state.m, cross4(state.m, state.material.mu0 * state.material.ms * state.mesh.V * Heff(state)));
    //return state.material.mu0 * state.material.ms * state.mesh.V * cross4(state.m, cross4(state.m, Heff(state)));
    ...
    //return pow(state.material.mu0, 2)/state.mesh.V * state.material.ms * cross4(state.m, cross4(state.m, Heff(state)));
    //return state.material.ms * cross4(state.m, cross4(state.m, Heff(state)));
}
