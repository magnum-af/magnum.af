...
DemagFieldMultithread::DemagFieldMultithread (Mesh meshin, Material paramin, bool verbose, bool caching, unsigned nthreads) : material(paramin),mesh(meshin), nthreads(nthreads > 0 ? nthreads : std::thread::hardware_concurrency()){
