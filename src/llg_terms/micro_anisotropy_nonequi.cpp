...
double NonequiUniaxialAnisotropyField::E(const State& state, const af::array& h){
    return - constants::mu0/2. * state.integral_nonequimesh(h * state.m);
}


NonequiUniaxialAnisotropyField::NonequiUniaxialAnisotropyField (double Ku1, std::array<double, 3> Ku1_axis) : Ku1(Ku1), Ku1_axis(get_normalized_vector(Ku1_axis)){
}


NonequiUniaxialAnisotropyField::NonequiUniaxialAnisotropyField (af::array Ku1_field, std::array<double, 3> Ku1_axis) : Ku1_field(Ku1_field), Ku1_axis(get_normalized_vector(Ku1_axis)){
}
...
NonequiUniaxialAnisotropyField::NonequiUniaxialAnisotropyField (double Ku1, long int Ku1_axis_field_ptr) : Ku1(Ku1), Ku1_axis_field(*( new af::array( *((void**) Ku1_axis_field_ptr)))){
}
...
// For wrapping only
NonequiUniaxialAnisotropyField::NonequiUniaxialAnisotropyField (double Ku1, double Ku1_axis_0, double Ku1_axis_1, double Ku1_axis_2) : Ku1(Ku1), Ku1_axis(get_normalized_vector(std::array<double, 3>{Ku1_axis_0, Ku1_axis_1, Ku1_axis_2})){
}


// For wrapping only
NonequiUniaxialAnisotropyField::NonequiUniaxialAnisotropyField (long int Ku1_field_ptr, double Ku1_axis_0, double Ku1_axis_1, double Ku1_axis_2) : Ku1_field(*( new af::array( *((void**) Ku1_field_ptr)))), Ku1_axis(get_normalized_vector(std::array<double, 3>{Ku1_axis_0, Ku1_axis_1, Ku1_axis_2})){
}
...
double NonequiUniaxialAnisotropyField::get_ku1_axis(int i){
    return Ku1_axis[i];
}
