...
RKKYExchangeField::RKKYExchangeField(RKKY_values rkky_values,
                                     Exchange_values exchange_values, Mesh mesh,
                                     const af::array& rkky_indices,
                                     bool verbose, bool COO)
    : matr(COO ? calc_COO_matrix(rkky_values.get(), exchange_values.get(), mesh,
                                 rkky_indices, verbose)
               : calc_CSR_matrix(rkky_values.get(), exchange_values.get(), mesh,
                                 rkky_indices, verbose)) {}

RKKYExchangeField::RKKYExchangeField(long int rkky_values,
                                     long int exchange_values, Mesh mesh,
                                     long int rkky_indices, bool verbose)
    : matr(calc_COO_matrix(*(new af::array(*((void**)rkky_values))),
                           *(new af::array(*((void**)exchange_values))), mesh,
                           *(new af::array(*((void**)rkky_indices))),
                           verbose)) {}
...
// A_exchange_field
af::array RKKYExchangeField::calc_CSR_matrix(const af::array& RKKY_field,
...
// Assembly of sparse matrix for spacially varying exchange energy
// A_exchange_field
af::array RKKYExchangeField::calc_COO_matrix(const af::array& RKKY_field,
                                             const af::array& A_exchange_field,
                                             const Mesh& mesh,
                                             const af::array& rkky_indices,
                                             const bool verbose) {
    ...
    if (verbose) {
        printf(
            "%s Finished sparse matrix setup in %f [s]. Initialized COO matrix "
