...
SparseExchangeField::SparseExchangeField(double A_exchange, Mesh mesh,
                                         bool verbose, bool COO)
    : matr(COO ? calc_COO_matrix(A_exchange, mesh, verbose)
               : calc_CSR_matrix(A_exchange, mesh, verbose)) {}

SparseExchangeField::SparseExchangeField(const af::array& A_exchange_field,
                                         Mesh mesh, bool verbose, bool COO)
...
SparseExchangeField::SparseExchangeField(long int A_exchange_field_ptr,
                                         Mesh mesh, bool verbose)
    : matr(calc_CSR_matrix(*(new af::array(*((void**)A_exchange_field_ptr))),
                           mesh, verbose)) {}
        ...
        for (unsigned i2 = 0; i2 < mesh.n2; i2++) {
            for (unsigned i1 = 0; i1 < mesh.n1; i1++) {
                for (unsigned i0 = 0; i0 < mesh.n0; i0++) {
                    ...
                    // y: interaction from (i0, i1, i2) to (i0, i1+-1, i2)
                    if ((i1 == 0 && mesh.n1 > 1) ||
                        (i1 > 0 && i1 < mesh.n1 - 1)) {
                        COO_values.push_back((2. * A_exchange) /
                                             (constants::mu0)*1. /
                    ...
                    // z: interaction from (i0, i1, i2) to (i0, i1, i2+-1)
                    if ((i2 == 0 && mesh.n2 > 1) ||
                        (i2 > 0 && i2 < mesh.n2 - 1)) {
                        COO_values.push_back((2. * A_exchange) /
                                             (constants::mu0)*1. /
...
af::array SparseExchangeField::calc_CSR_matrix(const double A_exchange,
                                               const Mesh& mesh,
                                               const bool verbose) {
    af::timer t;
    if (verbose)
                ...
                for (unsigned i1 = 0; i1 < mesh.n1; i1++) {
                    for (unsigned i0 = 0; i0 < mesh.n0; i0++) {
                        ...
                        if (ind == id) {
                            ...
                            // y: interaction from (i0, i1, i2) to (i0, i1+-1,
                            // i2)
                            if ((i1 == 0 && mesh.n1 > 1) ||
                                (i1 > 0 && i1 < mesh.n1 - 1)) {
                                CSR_values.push_back((2. * A_exchange) /
                            ...
                            // z: interaction from (i0, i1, i2) to (i0, i1,
                            // i2+-1)
                            if ((i2 == 0 && mesh.n2 > 1) ||
                                (i2 > 0 && i2 < mesh.n2 - 1)) {
                                CSR_values.push_back((2. * A_exchange) /
...
// A_exchange_field
af::array
SparseExchangeField::calc_CSR_matrix(const af::array& A_exchange_field,
                                     const Mesh& mesh, const bool verbose) {
    printf(
        "%s SparseExchangeField::calc_CSR_matrix unit testing not finished!\n",
        Warning());
    fflush(stdout);
    af::timer t;
    if (verbose)
...
// A_exchange_field
af::array
SparseExchangeField::calc_COO_matrix(const af::array& A_exchange_field,
                                     const Mesh& mesh, const bool verbose) {
    printf(
        "%s SparseExchangeField::calc_COO_matrix unit testing not finished!\n",
        Warning());
    fflush(stdout);
    af::timer t;
    if (verbose)
            ...
            for (unsigned i1 = 0; i1 < mesh.n1; i1++) {
                for (unsigned i0 = 0; i0 < mesh.n0; i0++) {
                    ...
                    if ((i2 == 0 && mesh.n2 > 1) ||
                        ...
                        double A_i =
                            a_raw[util::stride(i0, i1, i2, mesh.n0, mesh.n1)];
                        double A_i_p = a_raw[util::stride(i0, i1, i2 + 1,
                                                          mesh.n0, mesh.n1)];
                        if (A_i != 0) {
                            COO_values.push_back(
                                (2. * A_i) /
                    ...
                    if ((i2 == mesh.n2 - 1 && mesh.n2 > 1) ||
                        ...
                        double A_i =
                            a_raw[util::stride(i0, i1, i2, mesh.n0, mesh.n1)];
                        double A_i_m = a_raw[util::stride(i0, i1, i2 - 1,
                                                          mesh.n0, mesh.n1)];
                        if (A_i != 0) {
                            COO_values.push_back(
                                (2. * A_i) /
