...
class NonequiUniaxialAnisotropyField : public LLGTerm {
  public:
    NonequiUniaxialAnisotropyField (double Ku1, std::array<double, 3> Ku1_axis = {0, 0, 1});
    NonequiUniaxialAnisotropyField (af::array Ku1_field, std::array<double, 3> Ku1_axis = {0, 0, 1});
    ...
    NonequiUniaxialAnisotropyField (long int Ku1, double Ku1_axis_0, double Ku1_axis_1, double Ku1_axis_2);//!< wrapping only
    NonequiUniaxialAnisotropyField (long int Ku1_field_ptr, long int Ku1_axis_field_ptr);//!< wrapping only
    NonequiUniaxialAnisotropyField (double Ku1, long int Ku1_axis_field_ptr);//!< wrapping only
