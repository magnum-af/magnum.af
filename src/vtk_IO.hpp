...
void vtr_writer(const af::array& field, const float dx, const float dy, const std::vector<float> z_spacing, std::string outputname, const bool verbose = false);//Rectilinear grid writer
