...
void vti_writer_micro(const af::array field, const Mesh& mesh, std::string outputname){
    ...
    std::cout<<"vtk_writer_micro: Number of Cells:"<< field.dims(0)* field.dims(1)* field.dims(2) * field.dims(3)<<std::endl;
...
void vti_writer_atom(const af::array field, const Mesh& mesh, std::string outputname){
    ...
    std::cout<<"vti_writer_atom: Number of Points:"<< field.dims(0)* field.dims(1)* field.dims(2) * field.dims(3)<<std::endl;
...
void vti_reader(af::array& field, Mesh& mesh, std::string filepath){
    ...
    if(test_pixel==NULL){
        ...
        std::cout<<"Assuming input is vtkPointData as testpixel is not NULL"<<std::endl;
    }
...
void vtk_writer(const af::array field, const Mesh& mesh, std::string outputname){
