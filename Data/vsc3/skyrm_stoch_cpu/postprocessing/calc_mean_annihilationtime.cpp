...
int main(int argc, char** argv){
    ...
    std::cout << mean_detect_time <<"\t"<< unbiased_sample_variance <<"\t"<< unbiased_sample_sigma << std::endl;
    std::cout << "#mean_detect_time <<<< unbiased_sample_variance <<<< unbiased_sample_sigma" << std::endl;

    ofstream stream_out((string(argv[2])+"/mean_annihilationtime.dat").c_str());
    stream_out << mean_detect_time <<"\t"<< unbiased_sample_variance <<"\t"<< unbiased_sample_sigma << std::endl;
    stream_out << "#mean_detect_time <<<< unbiased_sample_variance <<<< unbiased_sample_sigma" << std::endl;
    stream_out.close();
