...
int main(int argc, char** argv) {
    // const std::vector<std::string> posargs = ArgParser(argc, argv).posargs;
    ...
    // const double val0{[posargs](std::size_t i) { return posargs.size() > i ? std::stod(posargs[i]) : 1.; }(0)};
    // const double val1{[posargs](std::size_t i) { return posargs.size() > i ? std::stod(posargs[i]) : 42.; }(1)};
    // const double val2{[posargs](std::size_t i) { return posargs.size() > i ? std::stod(posargs[i]) : 12.; }(2)};
