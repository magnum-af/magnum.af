...
class UniaxialAnisotropyField : public LLGTermMeshBase {
  public:
    ...
    UniaxialAnisotropyField(af::array Ku1_field,
                            std::array<double, 3> Ku1_axis = {0, 0, 1});
    UniaxialAnisotropyField(af::array Ku1_field, af::array Ku1_axis_field);
    UniaxialAnisotropyField(double Ku1, double Ku1_axis_0, double Ku1_axis_1,
                            double Ku1_axis_2);
    ...
    const af::array
        Ku1_field; //!< Spacially varying anisotropy energy in [J/m^3] defined
