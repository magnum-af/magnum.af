...
class AtomisticDipoleDipoleTest(unittest.TestCase):
  ...
  def test_atomistic_dipole_dipole_2_1_1_z_z(self):
    ...
    self.assertEqual(Llg.get_E(pystate), param.get_p()**2 * param.get_mu0()/(4.*math.pi)/self.dx**3)
    ...
    self.assertAlmostEqual(np_heff[0,0,0,2], -param.get_p() /4. /math.pi /self.dx**3 )
    self.assertAlmostEqual(np_heff[1,0,0,0], 0 )
    self.assertAlmostEqual(np_heff[1,0,0,1], 0 )
    self.assertAlmostEqual(np_heff[1,0,0,2], -param.get_p() /4. /math.pi /self.dx**3 )
  ...
  def test_atomistic_dipole_dipole_2_1_1_z_x(self):
    ...
    self.assertAlmostEqual(np_heff[0,0,0,0], 2*param.get_p() /4. /math.pi /self.dx**3  )
    self.assertAlmostEqual(np_heff[0,0,0,1], 0 )
  ...
  def test_atomistic_dipole_dipole_2_1_1_x_x(self):
    ...
    self.assertEqual(Llg.get_E(pystate), -param.get_p()**2 * param.get_mu0() /(2.*math.pi) /self.dx**3)

    af_heff = Llg.get_fheff(pystate)
    np_heff = af_heff.__array__()

    self.assertAlmostEqual(np_heff[0,0,0,0], param.get_p()/2./math.pi /self.dx**3 )
    self.assertAlmostEqual(np_heff[0,0,0,1], 0 )
    self.assertAlmostEqual(np_heff[0,0,0,2], 0 )
    self.assertAlmostEqual(np_heff[1,0,0,0], param.get_p()/2./math.pi /self.dx**3 )
    self.assertAlmostEqual(np_heff[1,0,0,1], 0 )
