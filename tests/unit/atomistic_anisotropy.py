...
class AtomisticAnisotropyTest(unittest.TestCase):
  ...
  def test_atomistic_anisotropy_2_1_1_z_z(self):
    ...
    atom_ani=magnum_af.ATOMISTIC_ANISOTROPY(mesh, param)
    Llg=magnum_af.NewLlg(atom_ani)

    self.assertAlmostEqual(Llg.get_E(pystate), -2*param.Ku1_atom)
    ...
    self.assertAlmostEqual(np_heff[0,0,0,2], 2*param.Ku1_atom/param.mu0/param.p )
  ...
  def test_atomistic_anisotropy_2_1_1_z_x(self):
    ...
    self.assertAlmostEqual(Llg.get_E(pystate), -param.Ku1_atom)
  ...
  def test_atomistic_anisotropy_1_2_1_z_z(self):
    ...
    self.assertAlmostEqual(np_heff[0,1,0,2], 2*param.Ku1_atom/param.mu0/param.p )
