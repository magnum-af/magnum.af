...
class AtomisticExchangeTest(unittest.TestCase):
  ...
  def test_atomistic_exchange_2_1_1_z_z(self):
    ...
    self.assertAlmostEqual(Llg.get_E(state), -param.get_J_atom())
    ...
    self.assertAlmostEqual(np_heff[0,0,0,2], param.get_J_atom()/param.get_mu0()/param.get_p() )
    self.assertAlmostEqual(np_heff[1,0,0,0], 0 )
    self.assertAlmostEqual(np_heff[1,0,0,1], 0 )
    self.assertAlmostEqual(np_heff[1,0,0,2], param.get_J_atom()/param.get_mu0()/param.get_p() )
  ...
  def test_atomistic_exchange_2_1_1_z_x(self):
    ...
    self.assertAlmostEqual(np_heff[0,0,0,0], param.get_J_atom()/param.get_mu0()/param.get_p() )
    self.assertAlmostEqual(np_heff[0,0,0,1], 0 )
  ...
  def test_atomistic_exchange_1_2_1_z_z(self):
    ...
    self.assertAlmostEqual(np_heff[0,1,0,2], param.get_J_atom()/param.get_mu0()/param.get_p() )
