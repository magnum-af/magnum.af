...
class ParamTest(unittest.TestCase):
  ...
  def test_param_initialization(self):
    material=magnumaf.Material(alpha=self.alpha, T=self.T, ms=self.ms, D=self.D, J_atom=self.J_atom, D_atom=self.D_atom, Ku1_atom_axis=self.Ku1_atom_axis, D_axis=self.D_axis, D_atom_axis=self.D_atom_axis)
