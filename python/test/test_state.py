...
class StateTest(unittest.TestCase):
    ...
    def test_material_setter_and_getter_for_ms(self):
        Ms = 1000
        state = magnumaf.State(magnumaf.Mesh(
            0, 0, 0, 0, 0, 0), Ms=Ms, m=self.m_af)
...
class StateMsLegacyDimTest(unittest.TestCase):
    ...
    state_legacy = magnumaf.State(
        magnumaf.Mesh(1, 1, 1, 1, 1, 1), Ms_legacy, m)
