...
class StateTest(unittest.TestCase):
    ...
    def test_Kc1_energy_array_input(self):
        ...
        Kc1_val = 1e6
        Kc1 = af.constant(Kc1_val, mesh.nx, mesh.ny,
                          mesh.nz, 1, dtype=af.Dtype.f64)
        ...
        E = caniso.Energy_in_J(state)
        # 250000 from: Kc1_E_density_analytic = Kc1 * (c1m2 * c2m2 + c1m2 * c3m2 + c2m2 * c3m2);
        self.assertAlmostEqual(E, mesh.nx * mesh.ny * mesh.nz * 250000 *
                               mesh.dx * mesh.dy * mesh.dz, 20)  # precision 36 for nx=ny=nz=1
