...
class AtomisticAnisotropyTest(unittest.TestCase):
    ...
    def test_atomistic_anisotropy_2_1_1_z_z(self):
        ...
        atom_ani = magnumaf.AtomisticUniaxialAnisotropyField(Ku1_atom, [
                                                             0, 0, 1])
        ...
        self.assertAlmostEqual(
            np_heff[0, 0, 0, 2], 2*Ku1_atom/magnumaf.Constants.mu0/p)
        self.assertAlmostEqual(np_heff[1, 0, 0, 0], 0)
        self.assertAlmostEqual(np_heff[1, 0, 0, 1], 0)
        self.assertAlmostEqual(
            np_heff[1, 0, 0, 2], 2*Ku1_atom/magnumaf.Constants.mu0/p)
    ...
    def test_atomistic_anisotropy_1_2_1_z_z(self):
        ...
        self.assertAlmostEqual(
            np_heff[0, 1, 0, 2], 2*Ku1_atom/magnumaf.Constants.mu0/p)
