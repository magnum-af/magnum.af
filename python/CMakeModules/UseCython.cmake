...
# cython_add_module( <name> src1 src2 ... srcN )
# Build the Cython Python module.
function( cython_add_module_w_AF_VTK _name )
  set( pyx_module_sources "" )
  set( other_module_sources "" )
  foreach( _file ${ARGN} )
    if( ${_file} MATCHES ".*\\.py[x]?$" )
  ...
  #if( APPLE )
  #  set_target_properties( ${_name} PROPERTIES LINK_FLAGS "-undefined dynamic_lookup" )
#    target_link_libraries( ${_name} ${PYTHON_LIBRARIES} ${ArrayFire_CPU_LIBRARIES} ${VTK_LIBRARIES})
  #else()
  ...
  IF(${ArrayFire_CUDA_FOUND} AND ${CUDA_FOUND})
      target_link_libraries( ${_name} magnum.af_CORE_SHARED ${PYTHON_LIBRARIES} ${ArrayFire_CUDA_LIBRARIES} ${VTK_LIBRARIES})
  ...
  # Maybe conflict with pth-mag cmake file
      target_link_libraries( ${_name} magnum.af_CORE_SHARED ${PYTHON_LIBRARIES} ${ArrayFire_OpenCL_LIBRARIES} ${VTK_LIBRARIES})
      MESSAGE(STATUS "CYTHON LINKING OpenCL BACKEND")
  ELSEIF(${ArrayFire_CPU_FOUND})
      target_link_libraries( ${_name} magnum.af_CORE_SHARED ${PYTHON_LIBRARIES} ${ArrayFire_CPU_LIBRARIES} ${VTK_LIBRARIES})
      MESSAGE(STATUS "CYTHON LINKING CPU BACKEND")
  ELSE ()
      MESSAGE(STATUS "ERROR: NO BACKEND FOUND")
  ENDIF()
endfunction()
#------------------------
#----- PTH Modified -----
