...
Currently, documentation is provided by the CI pipline and can be downloaded as a build artifact of the newest master branch build [here](https://git.exp.univie.ac.at/paul/magnum.af/-/pipelines?scope=all&page=1).
