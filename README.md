...
Currently, generated documentation is provided by the CI pipline and can be downloaded as a build artifact of the newest [master branch build](https://git.exp.univie.ac.at/paul/magnum.af/-/pipelines?scope=all&page=1).
...
For running simulations, you may use the provided script in [bash/magnum.af.docker](bash/magnum.af.docker), e.g.:

`$ magnum.af.docker sp4.py`

## Local installation:
For optinal GPU-support, first install a driver provided by your vendor.
